...
Generated pages, the [keyboard reference](/keys/) and the [filter reference](/features/filtering), are produced from the Go source. Do not hand-edit them; CI regenerates them and fails on a diff.
