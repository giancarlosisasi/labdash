...
If a token does expire while the dashboard is open, one key restarts the login and the sections resume where they were, with your scroll position and pinned tabs intact.
