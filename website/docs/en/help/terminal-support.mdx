...
<Keys>Ctrl+Z</Keys> suspends labdash and `fg` brings it back with the alternate screen, the cursor and your scroll position exactly as you left them. The shell you return to is the one you started from, with its scrollback untouched, because labdash draws on the alternate screen and never writes to yours.
