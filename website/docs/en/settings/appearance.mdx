...
| `confirmQuit` | `true`, `false` | Whether <Keys>q</Keys> asks before it exits. Off by default. Worth turning on if you reach for `q` in other applications and lose a half-typed comment to it |
